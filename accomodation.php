...
<body>
    <div class="container-fluid">
        ...
        <div class="content row">
            ...
            <div class="col-9">
                <p class="medium-text">All Acommodation</p>
                ...
                <div class="accomodation-listing">
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo '<div class="list">';
                              echo '<div class="row">';
                              echo '<div class="col-11"><p style="font-weight:bold;">Name of Service Provider: '.$row["firstName"].' '.$row["lastName"].'<span style="font-weight:bold;float:right;margin-right:25%;">Rent: '.$row["rent"].'$</span></p></div><hr>';
                              echo '<div class="col-1"><a class="tool" href="#"><i class="fas fa-star"></i></a></div>';
                              echo '</div>';
                              echo '<div class="description">';
                              echo '<h4>Accomodation Type: '.$row["bhk"].'BHK</h4>';
